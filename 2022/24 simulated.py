...
Q = deque([start])
while Q:
    (r, c, t, got_end, got_start,path) = Q.popleft()
    ...
    BAD = BAD_CELLS[t + 1]
    if (r, c) not in BAD:
        Q.append((r, c, t + 1, got_end, got_start,path+[(r,c,t)]))
    if (r + 1, c) not in BAD:
        Q.append((r + 1, c, t + 1, got_end, got_start,path+[(r,c,t)]))
    if (r - 1, c) not in BAD:
        Q.append((r - 1, c, t + 1, got_end, got_start,path+[(r,c,t)]))
    if (r, c + 1) not in BAD:
        Q.append((r, c + 1, t + 1, got_end, got_start,path+[(r,c,t)]))
    if (r, c - 1) not in BAD:
        Q.append((r, c - 1, t + 1, got_end, got_start,path+[(r,c-1,t)]))
